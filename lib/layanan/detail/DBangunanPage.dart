...
class DBangunanPage extends StatefulWidget {

  @override
  State<DBangunanPage> createState() => _DBangunanPageState();
}

class _DBangunanPageState extends State<DBangunanPage> {
