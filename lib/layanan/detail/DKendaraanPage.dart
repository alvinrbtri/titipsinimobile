...
class DKendaraanPage extends StatefulWidget {
  @override
  State<DKendaraanPage> createState() => _DKendaraanPageState();
}

class _DKendaraanPageState extends State<DKendaraanPage> {
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          HomeAppBar(),
          Padding(
            padding: EdgeInsets.only(top: 16, bottom: 2, left: 16, right: 16 ),
            child: Image.asset(
